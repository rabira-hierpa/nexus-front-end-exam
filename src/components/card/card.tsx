...
const Card: React.FC<ICardProps> = (props) => {
  const { id, title, description, icon, active, toggleActive } = props;
  return (
    <div
      key={id}
      className="flex items-center justify-center bg-gray-50 rounded-2xl w-72 h-24"
    >
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="py-3 sm:py-4">
          <div className="flex items-center space-x-4">
            <div className="flex-shrink-0">
              <img className="w-10 h-10 rounded" src={icon} alt={description} />
            </div>
